...
.form-control:focus {
    ...
    border-color: #ff14d2;
    outline: 0;
    -webkit-box-shadow: 0 0 0 0.2rem rgba(147, 0, 119, 0.25);
    box-shadow: 0 0 0 0.2rem rgba(147, 0, 119, 0.25)
}
...
.btn-primary.focus, .btn-primary:focus {
    -webkit-box-shadow: 0 0 0 0.2rem rgba(147, 0, 119, 0.5);
    box-shadow: 0 0 0 0.2rem rgba(147, 0, 119, 0.5)
}
...
.btn-warning.focus, .btn-warning:focus {
    -webkit-box-shadow: 0 0 0 0.2rem rgba(255, 161, 57, 0.5);
    box-shadow: 0 0 0 0.2rem rgba(255, 161, 57, 0.5)
}
...
.custom-control-input:focus ~ .custom-control-label:before {
    -webkit-box-shadow: 0 0 0 1px #fff, 0 0 0 0.2rem rgba(147, 0, 119, 0.25);
    box-shadow: 0 0 0 1px #fff, 0 0 0 0.2rem rgba(147, 0, 119, 0.25)
}
...
.custom-checkbox .custom-control-input:disabled:checked ~ .custom-control-label:before {
    background-color: rgba(147, 0, 119, 0.5)
}
...
.custom-select:focus {
    border-color: #ff14d2;
    outline: 0;
    -webkit-box-shadow: 0 0 0 0.2rem rgba(255, 20, 210, 0.5);
    box-shadow: 0 0 0 0.2rem rgba(255, 20, 210, 0.5)
}
...
a.bg-primary:focus, a.bg-primary:hover, button.bg-primary:focus, button.bg-primary:hover {
    background-color: #60004e !important
}
...
.bg-warning {
    background-color: #ffa139 !important
}
