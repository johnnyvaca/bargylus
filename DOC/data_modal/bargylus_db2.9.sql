-- --------------------------------------------------------
-- Hôte :                        web21.swisscenter.com
-- Version du serveur:           5.7.31-34-log - Percona Server (GPL), Release 34, Revision 2e68637
-- SE du serveur:                Linux
...
CREATE DATABASE IF NOT EXISTS `bargylus_db` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_bin */;
USE `bargylus_db`;
...
INSERT INTO `orders` (`id`, `number`, `total_price`, `user_id`, `states_id`, `date_purchase`) VALUES
	(4, 23423423, 45345, 13, 3, '2020-10-07'),
	(5, 8765423, 6643, 13, 3, '2020-10-07');
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `street_home` varchar(45) COLLATE utf8_bin NOT NULL,
  `zip` int(11) NOT NULL,
  `city` varchar(45) COLLATE utf8_bin NOT NULL,
  `canton` varchar(45) COLLATE utf8_bin NOT NULL,
...
INSERT INTO `users` (`id`, `email`, `lastname`, `firstname`, `phone_number`, `registration_date`, `birth_date`, `street_home`, `zip`, `city`, `canton`, `password`, `droits`) VALUES
	...
	(5, 'julien.ithurbide@cpnv.ch', 'ithurbide', 'julien', '0041 70 61 84 33', '0000-00-00', '0000-00-00', 'Ap #368-8278 Consectetuer Rd.', 1399, 'Kriens', 'JU', '$2y$10$kIsa6cW4xx1Zxy2/sH5Ev.tYk7GR9.LS/22MQceDck359wsASm2Yu', 0),
...
INSERT INTO `wines` (`id`, `year`, `winename`, `alcohol`, `basic_price`, `size`, `stock`, `photo`, `discounts_id`) VALUES
	(1, 2011, 'Amigne', 17, 32, 2, 23, 'wine_1.png', 2),
	(2, 2012, 'Païen', 18, 30, 1, 13, 'wine_2.png', 3),
	(3, 2013, 'Emitage', 16, 24, 2, 28, 'wine_3.png', 1),
	(4, 2014, 'Altesse', 20, 30, 1, 30, 'wine_4.png', 3),
	(5, 2015, 'petite-Arvine', 18, 30, 2, 25, 'wine_5.png', 1),
