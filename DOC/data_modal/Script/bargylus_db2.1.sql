...
-- Listage de la structure de la table bargylus_db. bottles
...
-- Listage des données de la table bargylus_db.bottles : ~12 rows (environ)
DELETE FROM `bottles`;
/*!40000 ALTER TABLE `bottles` DISABLE KEYS */;
INSERT INTO `bottles` (`id`, `grape`, `alcohol`, `basic_price`, `color`, `size`, `stock`, `photo`) VALUES
	(1, 'Couderc', 17, 32, 'blanc', 2, 30, 'wine_1.png'),
	(2, 'Landal', 18, 30, 'blanc', 1, 30, 'wine_2.png'),
	(3, 'Plant de Brunel', 16, 24, 'blanc', 2, 30, 'wine_3.png'),
	(4, 'Prunelard', 20, 30, 'blanc', 1, 30, 'wine_4.png'),
	(5, 'Alphonse Lavallée', 18, 30, 'blanc', 2, 30, 'wine_5.png'),
	(6, 'Aubun', 17, 28, 'blanc', 2, 30, 'wine_6.png'),
	(7, 'Béclan', 20, 24, 'blanc', 2, 30, 'wine_7.png'),
	(8, 'Aramon', 17, 32, 'blanc', 1, 30, 'wine_1.png'),
	(9, 'Couston', 16, 38, 'Rouge', 1, 30, 'wine_2.png'),
	(10, 'Poulsard', 16, 38, 'Rouge', 1, 30, 'wine_3.png'),
	(11, 'Malvoisie', 16, 38, 'blanc', 1, 30, 'wine_4.png'),
	(12, 'Macabeu', 20, 32, 'Rouge', 1, 30, 'wine_1.png');
...
-- Listage des données de la table bargylus_db.wines_compose_bottles : ~12 rows (environ)
