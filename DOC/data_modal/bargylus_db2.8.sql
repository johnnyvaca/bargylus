...
INSERT INTO `orders` (`id`, `number`, `total_price`, `user_id`, `states_id`) VALUES
	(1, 1, 500, 1, 2),
	(2, 2, 400, 1, 2),
	(3, 3, 300, 1, 2);
...
-- Listage des données de la table bargylus_db.orders_contain_wines : ~3 rows (environ)
...
INSERT INTO `wines` (`id`, `year`, `winename`, `alcohol`, `basic_price`, `size`, `stock`, `photo`, `discounts_id`) VALUES
	(1, 2011, 'Amigne', 17, 32, 2, 28, 'wine_1.png', 2),
	(2, 2012, 'Païen', 18, 30, 1, 14, 'wine_2.png', 3),
