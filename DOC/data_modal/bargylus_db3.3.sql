...
-- Listage des données de la table bargylus_db.invoices : ~5 rows (environ)
...
INSERT INTO `invoices` (`id`, `firstname`, `lastname`, `street`, `zip`, `city`, `user_id`, `visibility`) VALUES
	...
	(5, 'Johnny', 'Vaca', 'Chemin de renens 13', '1004', 'Lausanne', 13, 1);
...
-- Listage des données de la table bargylus_db.orders : ~9 rows (environ)
DELETE FROM `orders`;
...
INSERT INTO `orders` (`id`, `number`, `total_price`, `user_id`, `states_id`, `date_purchase`, `mode_payment_id`, `delivery_id`, `invoice_id`) VALUES
	...
	(6, 23423424, 26.1, 13, 1, '2020-11-03', 1, 7, 2),
	(7, 23423425, 26.1, 13, 1, '2020-11-03', 1, 7, 2),
	(8, 23423426, 26.1, 13, 1, '2020-11-03', 1, 7, 2),
	(9, 23423427, 26.1, 13, 1, '2020-11-03', 1, 7, 2),
	(10, 23423428, 26.1, 13, 1, '2020-11-03', 1, 7, 2),
	(11, 23423429, 26.1, 13, 1, '2020-11-03', 1, 7, 2),
	(12, 23423430, 26.1, 13, 1, '2020-11-03', 1, 7, 2);
...
-- Listage des données de la table bargylus_db.orders_contain_wines : ~7 rows (environ)
...
-- Listage des données de la table bargylus_db.users : ~0 rows (environ)
DELETE FROM `users`;
...
INSERT INTO `wines` (`id`, `year`, `winename`, `alcohol`, `basic_price`, `size`, `stock`, `photo`, `discounts_id`, `visibility`) VALUES
	(1, 2011, 'Amigne', 17, 32, 2, 17, 'wine_1.png', 2, 1),
	(2, 2012, 'Païen', 18, 30, 1, 22, 'wine_2.png', 3, 1),
	(3, 2013, 'Emitage', 16, 24, 2, 26, 'wine_3.png', 1, 1),
	(4, 2014, 'Altesse', 20, 30, 1, 16, 'wine_4.png', 3, 1),
	(5, 2015, 'petite-Arvine', 18, 30, 2, 12, 'wine_5.png', 1, 1),
	(6, 2016, 'Arvine', 17, 28, 2, 28, 'wine_6.png', 2, 1),
	(7, 2017, 'Aligoté', 20, 24, 2, 30, 'wine_7.png', 1, 1),
	(8, 2018, 'Muscat', 17, 32, 1, 30, 'wine_1.png', 1, 1),
	(9, 2019, 'Réze', 16, 38, 1, 14, 'wine_2.png', 3, 1),
	(10, 2010, 'Lafnetscha', 16, 38, 1, 27, 'wine_3.png', 1, 1),
	(11, 2009, 'Joubertin', 16, 38, 1, 30, 'wine_4.png', 3, 1),
	(12, 2008, 'Johannisberg', 20, 32, 1, 30, 'wine_1.png', 1, 1);
