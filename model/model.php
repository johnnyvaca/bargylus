...
function getOrders(){
    ...
    try {
        ...
        $query = 'select users.id, users.firstname, users.lastname,wines.winename, orders_contain_wines.quantity, orders_contain_wines.price as \'price_wine\', orders.number, orders.state, orders.total_price  FROM bargylus_db.orders_contain_wines
