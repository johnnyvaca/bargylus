...
function addNewWineToDisplay($wines){
    ...
    try {
        $dbh = getPDO();
        $query = "INSERT INTO wines (wines.year,winename, alcohol,basic_price,wines.size,stock,photo,discounts) 
                    VALUES (:wyear, :wname, :walcohol, :wprice, :wsize,:wstock,'photo',:wdiscounts_id)";
