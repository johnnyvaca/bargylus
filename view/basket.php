                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="product-name">
                                <h2 class="h5 cart-product-title text-black"><?= $oneBasketContent['winename'] ?>
                                    <br><?= $oneBasketContent['name'] ?><br><?= $oneBasketContent['color'] ?>
                                    <br><?= $oneBasketContent['year'] ?></h2>
                            </td>
                            ...
                            <td>
                                ...
                                <div class="input-group mb-3" style="max-width: 120px;">
                                    ...
                                    <input type="text" class="form-control text-center border-0 mr-sm-0"
                                           name='quantity[]' value="<?= $oneBasketContent['quantity'] ?>" placeholder=""
                            ...
                            <td><a href="index.php?action=removeWineBasket&id=<?= $oneBasketContent['id'] ?>"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="row mb-5">
                    ...
                    <div class="col-md-6">
                        <a href="index.php?action=displaywines">
                            <button class="btn btn-outline-primary btn-md btn-block">Continuer Shopping</button>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-7">
                ...
                <div class="row">
                    <form action="index.php" method="get">
                        ...
                        <div class="col-md-6">
                            <input type="text" list="users" name="id" placeholder="Choisir votre client">
                            <datalist id="users">
                                <?php
                ...
                <div class="row">
                        <div class="col-md-6">
                            <?php if (isset($_SESSION['basket'])) { ?>
                                <a href="index.php?action=proceedPayment&id=<?=$_SESSION['user']['id']?>" class="btn btn-primary btn-lg btn-block"
                                   onclick="window.location='checkout.html'">Procéder au paiement</a>
                            <?php } ?>
                        </div>
                </div>
                    <?php } ?>
